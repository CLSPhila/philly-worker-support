  ...
  return (
    <div>
      ...
      <p>
        ...
        employer-provided health insurance but might provide a higher amount of
        income because everyone receiving unemployment compensation between now
        and July 31, 2020 will automatically receive an additional $600 per
        week. The choice between these options might depend on how good your
