...
const PhillyLeaveIsPaid = () => {
  return (
    <p>
      ...
      this sick leave after you take FFCRA leave first. If your employer has 10
      or more employees, this leave must be paid.  If your employer has 9 or
      fewer employees, this leave may be unpaid. You have to accrue sick leave
      under the Philadelphia law. You earn 1 hour of sick time for every 40
      hours of work, and you can earn up to 40 hours of sick leave in total. It
      is your employer’s responsibility to keep track of how much sick time you
      have left. Your employer might give you more leave than the Philadelphia
      law requires, so you should check what their policy is.
    </p>
  );
};
